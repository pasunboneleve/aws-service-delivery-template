...
- cleanup destroy waits until AWS finishes by default; set
  `AWS_INTEGRATION_CLEANUP_TIMEOUT_SECONDS` to a positive value only if you
  explicitly want a timeout
